...
urlpatterns = [
    ...
    path('watch-stories/',views.watchStories,name='watch-stories'),
    path('tell-your-story/',views.submitStory,name='tell-your-story'),
    ...
    path("close-notification/",views.closeNotification),    
]