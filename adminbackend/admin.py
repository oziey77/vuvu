...
from adminbackend.models import AirtimeBackend, AirtimeDiscount, BillServicesDiscount, CableBackend, DashboardNotification, DataBackend, EPINBackend, ElectricityBackend
...
admin.site.register(BillServicesDiscount)
